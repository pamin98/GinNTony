...
{
       0,   118,   118,   122,   127,   131,   132,   133,   134,   138,
     139,   143,   144,   148,   149,   153,   154,   158,   159,   163,
     164,   168,   169,   170,   171,   172,   177,   182,   183,   184,
     185,   186,   191,   192,   196,   197,   201,   202,   203,   207,
     208,   212,   216,   217,   221,   222,   226,   227,   228,   229,
...
yyreduce:
  ...
  case 3:
#line 122 "parser.y"
    { (yyvsp[-2].def_list)-> reverse(); (yyvsp[-1].stmt_list)->reverse(); 
...
#line 1531 "parser.cpp"
  ...
  case 14:
#line 149 "parser.y"
    { (yyvsp[0].formal_list)->append((yyvsp[-1].formal)) ; (yyvsp[0].formal_list)->reverse(); (yyval.formal_list) = (yyvsp[0].formal_list); }
...
#line 1549 "parser.cpp"
  ...
  case 17:
#line 158 "parser.y"
    { (yyvsp[0].var_list)->reverse(); (yyval.formal) = new Formal((yyvsp[-1].type),(yyvsp[0].var_list)); }
#line 1555 "parser.cpp"
    break;

  case 18:
#line 159 "parser.y"
    { (yyvsp[0].var_list)->reverse(); (yyval.formal) = new Formal((yyvsp[-1].type),(yyvsp[0].var_list),true); }
...
#line 1603 "parser.cpp"
  ...
  case 26:
#line 177 "parser.y"
    { (yyvsp[0].var_list)->reverse(); (yyval.var_definition) = new VarDefinition((yyvsp[-1].type),(yyvsp[0].var_list)); }
...
#line 1627 "parser.cpp"
  ...
  case 30:
#line 185 "parser.y"
    { (yyvsp[-2].stmt_list)-> reverse(); (yyval.stmt) = new If((yyvsp[-4].expr),(yyvsp[-2].stmt_list),(yyvsp[-1].ifClass)); }
#line 1633 "parser.cpp"
    break;

  case 31:
#line 186 "parser.y"
    { (yyvsp[-7].stmt_list)-> reverse(); (yyvsp[-3].stmt_list)->reverse(); (yyvsp[-1].stmt_list)-> reverse(); 
...
#line 1646 "parser.cpp"
  ...
  case 33:
#line 192 "parser.y"
    { (yyvsp[-1].stmt_list)-> reverse(); (yyval.ifClass) = new If((yyvsp[-3].expr),(yyvsp[-1].stmt_list),(yyvsp[0].ifClass)); }
...
#line 1658 "parser.cpp"
  ...
  case 35:
#line 197 "parser.y"
    { (yyvsp[0].stmt_list)-> reverse(); (yyval.ifClass) = new If(NULL,(yyvsp[0].stmt_list),NULL); }
